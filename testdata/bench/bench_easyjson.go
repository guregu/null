...
func easyjson1a4b97d4DecodeGithubComUnravelinNullTestdataBench(in *jlexer.Lexer, out *pltest) {
...
func easyjson1a4b97d4EncodeGithubComUnravelinNullTestdataBench(out *jwriter.Writer, in pltest) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v pltest) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson1a4b97d4EncodeGithubComUnravelinNullTestdataBench(w, v)
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *pltest) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1a4b97d4DecodeGithubComUnravelinNullTestdataBench(l, v)
}
